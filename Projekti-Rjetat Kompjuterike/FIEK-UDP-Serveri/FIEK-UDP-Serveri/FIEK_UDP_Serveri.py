...
print("----Serveri eshte gati te pranoj kerkesa----")
print('Kerkesat:')
        ...
        try:
            ...
            while str(fjalia.decode())!="":
                try:
                    ...
                    fjalia,addr = serverSocket.recvfrom(128)
                    fjaliaU=fjalia.upper()
                    kerkesa = fjaliaU.decode("UTF-8");
                    print(fjalia.decode("UTF-8"))
                ...
                if (kerkesa[0] == "IPADRESA"):
                    ...
                    serverSocket.sendto(pergjFinale.encode("UTF-8"),addr)
                    ...
                    serverSocket.sendto("KERKESA NUK ESHTE VALIDE".encode("UTF-8"),addr)
       
        except Exception as e:
            print("Ka ndodhur ndonje gabim")
            print(str(e))
